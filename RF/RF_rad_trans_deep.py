...
# With this, names of features are lost---delete
#radiomics_selected = selector_var.fit_transform(radiomics_pd)
#transcriptomics_selected = selector_var.fit_transform(transcriptomics_pd)
...
for model_name in deep.keys():
    ...
    for index,split in enumerate(kfolds):
        ...
        path="results/RF_rad_trans_deep/"+model_name+"_RF_nsplit"+str(index)
        os.mkdir(path)
        ...
        #print('selected transcriptomics' , selected_transcriptomics, type(selected_transcriptomics))
        ...
        for key in list(selected_deep.keys()):
            try:
                ...
                print(key)
                continue 
        #print(combined_patterns_rad_trans_deep)
